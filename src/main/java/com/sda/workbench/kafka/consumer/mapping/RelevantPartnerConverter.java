...
public class RelevantPartnerConverter
		extends
			BidirectionalConverter<com.sda.workbench.kafka.consumer.document.rest.model.RelevantPartner, RelevantPartner> {
	@Override
	public RelevantPartner convertTo(com.sda.workbench.kafka.consumer.document.rest.model.RelevantPartner source,
	...
	@Override
	public com.sda.workbench.kafka.consumer.document.rest.model.RelevantPartner convertFrom(RelevantPartner source,
		...
		if (source != null) {
			...
			//
			// return new
			// com.sda.workbench.kafka.consumer.document.rest.model.SoRKey(sorKeyElements);
		}
